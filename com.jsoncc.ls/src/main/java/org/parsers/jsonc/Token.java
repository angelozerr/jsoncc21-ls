...
import java.util.*;
public class Token implements JSONCConstants, Node {
    ...
    public static Token newToken(TokenType type, String image, String inputSource) {
        switch(type) {
            ...
            return new Comment(TokenType.SINGLE_LINE_COMMENT, image, inputSource);
            case MULTI_LINE_COMMENT:
            return new Comment(TokenType.MULTI_LINE_COMMENT, image, inputSource);
            case WHITESPACE:
    ...
    public static Token newToken(TokenType type, String image, JSONCLexer lexer) {
        return newToken(type, image, lexer.getInputSource());
    }

    public static Token newToken(TokenType type, String image, JSONCParser parser) {
