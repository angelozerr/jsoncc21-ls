...
import static com.jsoncc.ls.settings.capabilities.ServerCapabilitiesConstants.CODE_LENS_ID;
import static com.jsoncc.ls.settings.capabilities.ServerCapabilitiesConstants.COMPLETION_ID;
...
import static com.jsoncc.ls.settings.capabilities.ServerCapabilitiesConstants.DEFINITION_ID;
import static com.jsoncc.ls.settings.capabilities.ServerCapabilitiesConstants.DOCUMENT_HIGHLIGHT_ID;
import static com.jsoncc.ls.settings.capabilities.ServerCapabilitiesConstants.DOCUMENT_SYMBOL_ID;
import static com.jsoncc.ls.settings.capabilities.ServerCapabilitiesConstants.FOLDING_RANGE_ID;
import static com.jsoncc.ls.settings.capabilities.ServerCapabilitiesConstants.FORMATTING_ID;
import static com.jsoncc.ls.settings.capabilities.ServerCapabilitiesConstants.LINK_ID;
import static com.jsoncc.ls.settings.capabilities.ServerCapabilitiesConstants.REFERENCES_ID;
import static com.jsoncc.ls.settings.capabilities.ServerCapabilitiesConstants.TEXT_DOCUMENT_CODE_LENS;
import static com.jsoncc.ls.settings.capabilities.ServerCapabilitiesConstants.TEXT_DOCUMENT_COMPLETION;
import static com.jsoncc.ls.settings.capabilities.ServerCapabilitiesConstants.TEXT_DOCUMENT_DEFINITION;
import static com.jsoncc.ls.settings.capabilities.ServerCapabilitiesConstants.TEXT_DOCUMENT_DOCUMENT_SYMBOL;
import static com.jsoncc.ls.settings.capabilities.ServerCapabilitiesConstants.TEXT_DOCUMENT_FOLDING_RANGE;
import static com.jsoncc.ls.settings.capabilities.ServerCapabilitiesConstants.TEXT_DOCUMENT_FORMATTING;
import static com.jsoncc.ls.settings.capabilities.ServerCapabilitiesConstants.TEXT_DOCUMENT_HIGHLIGHT;
import static com.jsoncc.ls.settings.capabilities.ServerCapabilitiesConstants.TEXT_DOCUMENT_LINK;
import static com.jsoncc.ls.settings.capabilities.ServerCapabilitiesConstants.TEXT_DOCUMENT_REFERENCES;
